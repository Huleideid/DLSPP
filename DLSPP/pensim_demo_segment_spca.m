...
%% 
[segment,~,Wc] = pcaseg_batch_spca(final,2,q,flag,1);
Wc=fliplr(Wc');%转置
Wc=Wc(1:200);
figure
set(gcf,'color','w')
...
%% 
num=50;
[~,~,T2_cost] = pcaseg_batch_spca(final,2,q,0);
[~,~,SPE_cost] = pcaseg_batch_spca(final,2,q,1);
...
%% 
t0=cputime;
[segment,~,wc] = pcaseg_batch_spca(final,10,q,flag,1);
t1=cputime-t0;
